...
export default function Home() {
  return (
    <div className="min-h-screen bg-creamBg text-charcoalText font-sans relative">
      ...
      {/* Sticky Floating Widgets (CRO Boosters) */}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden glass-capsule py-3 px-4 shadow-2xl flex gap-4 mx-4 mb-4 rounded-2xl">
        <a
          ...
          className="flex-1 flex items-center justify-center space-x-2 bg-primaryGreen text-whitePure py-3 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-accentRose transition-colors"
        >
          <Phone size={14} />
        ...
        <a
          href="#contact"
          className="flex-1 flex items-center justify-center bg-accentRose text-whitePure py-3 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-primaryGreen transition-colors"
        >
          <span>Book Now</span>
        </a>
      </div>
